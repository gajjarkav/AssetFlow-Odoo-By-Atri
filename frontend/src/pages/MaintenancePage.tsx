      ...
      <div className="flex-1 flex gap-4 overflow-x-auto pb-4">
        {isLoading ? (
          ...
          columns.map(col => {
            ...
            return (
              <div key={col.id} className="flex-shrink-0 w-80 bg-slate-50/50 border border-slate-200 rounded-2xl flex flex-col h-[calc(100vh-200px)] shadow-sm">
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-3">
                  {colItems.map((item: any) => (
                    <div key={item.id} className="bg-white border border-slate-200 rounded-xl p-3 hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer group shadow-sm">
