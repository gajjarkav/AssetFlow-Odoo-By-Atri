...
export function TabsList({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <div className={cn("inline-flex h-10 items-center justify-center rounded-md bg-[#0B0B0F] p-1 text-[#94A3B8]", className)}>
      {children}
    </div>
  )
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected ? "bg-[#1A1A22] text-[#F8FAFC] shadow-sm" : "hover:text-[#F8FAFC]",
        className
      )}
    >
      {children}
